...
def eval_func(doc_couples_all, doc_couples_pred_all):
    ...
    for doc_couples, doc_couples_pred in zip(doc_couples_all, doc_couples_pred_all):
        doc_couples = set(doc_couples)
        doc_couples_pred = set(doc_couples_pred)
        ...
        doc_caus = set([int(doc_couple)%10 for doc_couple in doc_couples])
        doc_caus_pred = set([int(doc_couple)%10 for doc_couple in doc_couples_pred])
